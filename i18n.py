...
TRANSLATIONS = {
    "uz": {
        ...
        "note_limit_full": "Limit {mx} · Qolgan {rem} · {p}%",
        "stats_limits": "Limit — 5 soatlik: {s5} · Haftalik: {wk} token",
        "stats_sub": "🗓 Obuna: {days} kun qoldi ({date} da yangilanadi)",
        "stats_sub_today": "🗓 Obuna: bugun yangilanadi",
        "stats_sub_none": "🗓 Obuna sanasi kiritilmagan (Sozlamalarda kiriting)",
        ...
        "set_sub_date": "Obuna boshlangan sana (YYYY-MM-DD)",
    ...
    "ru": {
        ...
        "note_limit_full": "Лимит {mx} · Осталось {rem} · {p}%",
        "stats_limits": "Лимит — 5 часов: {s5} · Неделя: {wk} токенов",
        "stats_sub": "🗓 Подписка: осталось {days} дн (обновление {date})",
        "stats_sub_today": "🗓 Подписка: обновляется сегодня",
        "stats_sub_none": "🗓 Дата подписки не указана (укажите в Настройках)",
        "period_5h": "5-часовое",
        ...
        "set_sub_date": "Дата начала подписки (ГГГГ-ММ-ДД)",
    ...
    "en": {
        ...
        "note_limit_full": "Limit {mx} · Left {rem} · {p}%",
        "stats_limits": "Limit — 5-hour: {s5} · Weekly: {wk} tokens",
        "stats_sub": "🗓 Subscription: {days} days left (renews {date})",
        "stats_sub_today": "🗓 Subscription: renews today",
        "stats_sub_none": "🗓 Subscription date not set (add it in Settings)",
        "period_5h": "5-hour",
        ...
        "set_sub_date": "Subscription start date (YYYY-MM-DD)",
